...
// PIE CHART AND BUBBLE CHART BUILD
// GRAB THE URL DATA CREATED BY FLASK 

  var pie_url = "/samples/" + sample;
  console.log(pie_url);

   // souncing pie chart visual ideas from a really great looking pie chart option:  https://code.tutsplus.com/tutorials/create-interactive-charts-using-plotlyjs-pie-and-gauge-charts--cms-29216
// USE JSON TO GRAB THE URL DATA
   ...
   var trace = [{
      ...
      hole: .30,
      marker: {
        colors: ['forestgreen','#12616b','violet','#bf4239','pink','blue','#8e9923','gray','#cc2cc9','orange'],
        line: {
          color: 'vanilla',
          width: 5
        }
